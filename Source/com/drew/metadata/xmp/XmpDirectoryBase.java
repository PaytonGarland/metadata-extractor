...
public abstract class XmpDirectoryBase extends Directory
{
    ...
    {
        map.put(TAG_XMP_VALUE_COUNT, "XMP Value Count");
        map.putAll(map);
    }
    ...
    public XmpDirectoryBase()
    {
        this.setDescriptor(new XmpDescriptorBase(this));
    }
