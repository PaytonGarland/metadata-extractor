...
import com.drew.metadata.mp4.media.Mp4VideoDescriptor;

import java.util.HashMap;

public class TgpVideoDirectory extends TgpMediaDirectory
{
    ...
    public TgpVideoDirectory()
    {
        this.setDescriptor(new TgpVideoDescriptor(this));
    }
