...
public class MovieHeaderBox extends FullBox
{
    ...
    public void addMetadata(TgpDirectory directory)
    {
        ...
        directory.setString(TgpDirectory.TAG_CREATION_TIME, creationTimeStamp);
        directory.setString(TgpDirectory.TAG_MODIFICATION_TIME, modificationTimeStamp);
        ...
        directory.setString(TgpDirectory.TAG_DURATION, time);
        directory.setLong(TgpDirectory.TAG_TIME_SCALE, timescale);

        directory.setIntArray(TgpDirectory.TAG_TRANSFORMATION_MATRIX, matrix);
        ...
        directory.setDouble(TgpDirectory.TAG_PREFERRED_RATE, preferredRateInteger + preferredRateFraction);
        ...
        directory.setDouble(TgpDirectory.TAG_PREFERRED_VOLUME, preferredVolumeInteger + preferredVolumeFraction);

        directory.setLong(TgpDirectory.TAG_NEXT_TRACK_ID, nextTrackID);
    }
}
